...
5. When the verdict is ready, stop. Write one tool-free final assistant message whose JSON matches the output schema; you MAY still `yield` the same object in `data`. Do not keep searching for completeness
